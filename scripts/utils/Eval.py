...
RESULT_PATH = "results/baseline_results_1199_20250710_184124.jsonl"
OUTPUT_PATH = "results/error_type_baseline_recall_1199_20250710_184124——2.json"
...
for r, d in zip(results, raw_data):
    # 跳过不匹配项
