...
from utils import extract_schema_from_sqlite, build_prompt, query_gpt, parse_answer
...
RESULT_PATH = f"results/baseline_results_{MAX_EXAMPLES}_{timestamp}.jsonl"
...
eval_path = f"results/eval_summary_{MAX_EXAMPLES}_{timestamp}.json"
